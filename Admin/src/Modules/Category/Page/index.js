...
// @services
import { getListCategory, deleteCategory } from "../Store/service";
...
function CategoryPage() {
  ...
  const goToCreateCategory = () => {
    history.push("/manage-categories/create-category");
  };

  const goToEditProduct = (record) => {
    // console.log("record", record?._id);
    history.push({
      pathname: "/manage-categories/update-category",
      state: {
        idCate: record?._id,
      },
    });
