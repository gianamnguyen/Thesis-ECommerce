...
class PaymentController {
  createPaymentMomo(request, response, next) {
    ...
    var redirectUrl = "http://localhost:3002/thank";
  ...
  createPaymentMomoOrderCustomizedProduct(request, response, next) {
    //parameters
    var partnerCode = "MOMO";
    var accessKey = "F8BBA842ECF85";
    var secretkey = "K951B6PE1waDMi640xX08PD3vg6EkVlz";
    ...
    var requestId = partnerCode + new Date().getTime();
    var requestType = "payWithATM"
    var redirectUrl = "http://localhost:3000/customize-product/manage/thank";
    var ipnUrl = "https://webhook.site/454e7b77-f177-4ece-8236-ddf1c26ba7f8";
    // var ipnUrl = redirectUrl = "https://webhook.site/454e7b77-f177-4ece-8236-ddf1c26ba7f8";
    var extraData = ""; //pass empty value if your merchant does not have stores
